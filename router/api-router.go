	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/referrals", controller.GetUserReferralDetails)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/user_subscriptions", controller.AdminListUserSubscriptionOverview)
			subscriptionAdminRoute.GET("/users/:id/subscriptions", controller.AdminListUserSubscriptions)
			subscriptionAdminRoute.POST("/users/:id/subscriptions", controller.AdminCreateUserSubscription)
			subscriptionAdminRoute.POST("/user_subscriptions/:id/invalidate", controller.AdminInvalidateUserSubscription)
			subscriptionAdminRoute.PATCH("/user_subscriptions/:id/time", controller.AdminAdjustUserSubscriptionTime)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/batch/test", controller.BatchTestChannels)
		...
		logRoute.GET("/email", middleware.RootAuth(), controller.GetEmailLogs)
